...
def main():
    ...
    for i in range(num_vms):
        ...
        print('\n')
        print('The final new vm characteristics')
        print(f"Final vm id: {vm_afterDb.id}")
        print(f"Final cpu: {vm_afterDb.cpu}")
        print(f"Final memory: {vm_afterDb.memory}")
        print(f"Final hour rate: {vm_afterDb.hourrate}")
        print(f"Final location: {vm_afterDb.location}")
        print(f"Final csp: {vm_afterDb.csp}")
        print(f"Final processing time: {vm_afterDb.processingtime}")
        print(f"\n")
        ...
        """print(f'\n')
        print(f'Printing the vmlist before search...')
        print(vmList_beforeDbSearch)"""
        
        vmList_afterDbSearch.append(vm_afterDb)
        """print(f'\n')
        print(f'Printing the vmlist after search...')
        print(vmList_afterDbSearch)"""
