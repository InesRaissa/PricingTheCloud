...
from getInputsFromIniConfigFile import get_vms_from_iniConfigFile
from getInputsFromIniConfigFile import get_correspondingLinks_from_iniConfigFile
...
def main():
   ...
   #initialising all the variables 
    ...
    vms_list = get_vms_from_iniConfigFile(config)

    # Establish links between VMs
    get_correspondingLinks_from_iniConfigFile(config, vms_list)


    #ancien code non encore adapté        
